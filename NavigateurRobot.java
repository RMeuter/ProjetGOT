 ...
 */
	...
	/**
	 * Fonction qui vérifie en premier si la liste chemin n'est pas vide. 
	 ...
	 * Sinon il recule.
	 * Après cela, il tourne de 90 degres, avec plus ou moins son biais.
	 * 
	 * Cette fonction vérifie également si le robot doit s'arrêter durant le temps que 
	 ...
	 * Si cette étape existe, il redefinira son objectif et sa position.
	 */
